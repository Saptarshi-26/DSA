...
public class Smallest_range_covering_elements_from_k_lists {
    ...
    public int upper_range(int i, int j, List<List<Integer>> nums, int[] arr, int lowe_range) {
        ...
        while (i <= j) {
            ...
            if (check_valid_upper_range(nums, arr[mid], lowe_range)) {
    ...
    public int[] smallestRange(List<List<Integer>> nums) {
        ...
        for (int i = 0; i < arr.length; i++) {
            ...
            if (check_valid_lower_range(nums, arr[i])) {
                ...
                int upper_range_val = upper_range(i, arr.length - 1, nums, arr, arr[i]);
    ...
    public static void main(String[] args) {
        ...
        Smallest_range_covering_elements_from_k_lists smallestRangeCoveringElementsFromKLists = new Smallest_range_covering_elements_from_k_lists();
